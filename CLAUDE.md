...
- `cmd/postgres4all` — cobra; `generate`/`install`/`update` are ported; `apply-functions` is a stub.
Tests: `go test ./...` (table + golden). Generated init SQL carries `-- generated by postgres4all; do not edit`.
